...
[assembly: WebActivator.PreApplicationStartMethod(typeof(StackPOS.App_Start.AppHost), "Start")]
...
namespace StackPOS.App_Start
{
	...
	{		
		...
		public override void Configure(Funq.Container container)
		{
			...
			container.Register(new TransactionRepository());
            container.Register(new ProductRepository());	
